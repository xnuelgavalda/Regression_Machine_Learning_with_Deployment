...
Entwicklung eines Regressionsmodells zur Vorhersage der Zulassung von Universitätsstudenten unter Verwendung verschiedener Algorithmen wie Lineare Regression, Lasso, Ridge, ElasticNet, Entscheidungsbaum, Zufalls-Wald, k-nächster Nachbar und Support-Vektor-Maschinen, unter Anwendung von Regularisierung und Hyperparameter-Abstimmungstechniken.

[Dataset](https://www.kaggle.com/adityadeshpande23/admissionpredictioncsv)

University dataset features:
...
Key Features:
- Implemented multiple regression algorithms and regularization techniques for precise prediction.
- Utilized Hyperparameter Tuning and GridSearchCV techniques for model optimization.
...
![page1](images/deploymentShoot.png)
